...
const Player = () => {
  const { track,seekBar, seekBg, playerStatus, play, pause,time,Previous,next,handleSeek, } = useContext(PlayerContext);
    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
      ...
      <div className='flex flex-col items-center gap-1 m-auto'>
        ...
        <div className='flex items-center gap-5'>
          ...
          <div ref={seekBg} onClick={handleSeek} className='w-[40vw] max-w-[300px] bg-gray-300 rounded-full cursor-pointer'>
